    ...
    <div className="group bg-linear-to-br from-[#0a0e1a] to-[#1a1f3a] rounded-2xl overflow-hidden border border-purple-500/10 hover:border-purple-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <button className="flex-1 py-2 px-4 text-sm font-semibold rounded-xl bg-linear-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/50">
            Demo
          </button>
          <button className="flex-1 py-2 px-4 text-sm font-semibold rounded-xl border-2 border-purple-500 text-white hover:bg-purple-500/10 transition-all duration-300 hover:scale-105">
            Source Code
          </button>
        </div>
      </div>
